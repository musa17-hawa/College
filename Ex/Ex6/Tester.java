public class Tester{
	public static void main(String[] args) {
		int[] a = {1,2}; //{1,2}
		int[] b = {1,2,3,4,1,2,5,6,1,2};//{1,2,1,2} //{2,3,4,1,3,5,5} ==> {2,3,4,3,5,5,5}
		//        {4,1,2,3} ==> {4,3}
		//							 {}
		...
		System.out.println("what is the length of the longestPrefixAndSuffix ? : " + array1.longestPrefixAndSuffix());
		System.out.println(array + " + " + array1 + " ==> "+array.uniteWith(array1));
		System.out.print(array1 + " - " + array + " ==> ");array1.removeSub(array);
